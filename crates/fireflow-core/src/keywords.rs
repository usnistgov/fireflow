...
// pub const NS_CYTSN: &str = "CYTSN"; // since 3.0
// pub const NS_TIMESTEP: &str = "TIMESTEP"; // since 3.0
// pub const NS_UNICODE: &str = "UNICODE"; // 3.0 only
// pub const NS_COMP: &str = "COMP"; // 3.0 only

// pub const NS_VOL: &str = "VOL"; // since 3.1
// pub const NS_FLOWRATE: &str = "FLOWRATE"; // since 3.1
// pub const NS_SPILLOVER: &str = "SPILLOVER"; // since 3.1
// pub const NS_PLATEID: &str = "PLATEID"; // since 3.1
// pub const NS_PLATENAME: &str = "PLATENAME"; // since 3.1
// pub const NS_WELLID: &str = "WELLID"; // since 3.1
// pub const NS_LAST_MODIFIER: &str = "LAST_MODIFIER"; // since 3.1
// pub const NS_LAST_MODIFIED: &str = "LAST_MODIFIED"; // since 3.1
// pub const NS_ORIGINALITY: &str = "ORIGINALITY"; // since 3.1

// pub const NS_BEGINDATETIME: &str = "BEGINDATETIME"; // since 3.2
// pub const NS_ENDDATETIME: &str = "ENDDATETIME"; // since 3.2
// pub const NS_CARRIERID: &str = "CARRIERID"; // since 3.2
// pub const NS_CARRIERTYPE: &str = "CARRIERTYPE"; // since 3.2
// pub const NS_LOCATIONID: &str = "LOCATIONID"; // since 3.2
// pub const NS_UNSTAINEDCENTERS: &str = "UNSTAINEDCENTERS"; // since 3.2
// pub const NS_UNSTAINEDINFO: &str = "UNSTAINEDINFO"; // since 3.2
