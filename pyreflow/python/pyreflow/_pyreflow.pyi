...
class VariableUintHeaders(_LayoutEndianCommon, _LayoutUnmixedCommon):
    def __new__(
        cls, ranges: list[pft.IntRange], endian: pft.Endian = "little"
    ) -> Self: ...
    @property
    def ranges(self) -> list[pft.IntRange]: ...
    @property
...
class MixedHeaders(_LayoutEndianCommon):
    def __new__(
        cls, typed_ranges: list[pft.MixedType], endian: pft.Endian = "little"
    ) -> Self: ...
    @property
    def typed_ranges(self) -> list[pft.MixedType]: ...
    @property
    def endian(self) -> pft.Endian: ...
    @property
    def byte_widths(self) -> list[int]: ...
...
class _CoreDatasetRemove(Generic[_N, _O, _T]):
    ...
    def remove_measurement_by_index(
        self, index: pft.MeasIndex
    ) -> tuple[_N, _O | _T, Series, pft.Range]: ...
