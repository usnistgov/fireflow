...
class DatasetDiagnostics:
    ...
    @property
    def read_other_analysis_ns(self) -> int: ...
    @property
    def read_crc_ns(self) -> int: ...
    @property
    def read_dark_bytes_ns(self) -> int: ...
    @property
    def scan_next_ns(self) -> int: ...
