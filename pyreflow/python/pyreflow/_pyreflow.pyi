...
class _CoreTEXTGetSetMeas(Generic[_N, _T, _O]):
    def push_optical(
        self, name: _N, meas: _O, range: Range, disallow_trunc: bool | None = False
    ) -> None: ...
    def insert_optical(
        self,
        index: MeasIndex,
        ...
        meas: _O,
        range: Range,
        disallow_trunc: bool | None = False,
    ) -> None: ...
    def push_temporal(
        self,
        name: Shortname,
...
def fcs_read_flat_text(
    ...
    allow_empty_values: TriFlag = False,
    ...
    demote_from_standard: KeyPatterns = pfd._DEFAULT_KEY_PATTERNS,
